// function printFullName (name=lorem,surname=ipsum) {
//     return `i am ${name} ${surname}`
// }

// console.log(printFullName("nihad","hesenli"));
...
// function numMultipy(a,b) {
//     return a*b
// }

// console.log(numMultipy(4,5));
...
// console.log(sumNumbers([80, 5, 58, 17, 100]));
...
// console.log(MaxElement([90,43,5,62,3,432,45]));
...
// let numberDivCheck = (number) =>{

// if (number % 2 === 0 && number % 3 === 0 && number % 5 === 0) {
//  return `${number} 2 ,3 ,5 bolunur `
// }else{
//     return `basqa eded yaz`
...
//         sumAllNumbers += arrat[i]
        
//     }
//     return sumAllNumbers
// }
//  console.log(sumArray([23,42,43,62,77,9]));

// Bir array-i tərsinə çevirən bir funksiya yaradın.

// let arrayReversed = (array) =>{
//     let reversed = []
...
//     return reversed
// }
// console.log(arrayReversed([43,53,62,34,7]));
...
//             return `kecdin`
//         }else{
//             return`get tezden oxu`
//         }
        
//     }
// }

//  console.log(scores([43,76,34,52]));
//  console.log(scores([61,76,74,92]));
 

// Verilmiş bir ədədin 10-dan kiçik, bərabər və ya böyük olduğunu yoxlayan bir funksiya yaradın

// let numberQuantityCheack = (number) =>{ 
//         if (number > 10) {
//             return `${number} 10 dan boyukdu` 
//         }
//         else if (number < 10) {
//             return `${number} 10 dan kicikdi`
//         }
//         else{
//             return `${number} 10-a beraberdir`
//         }
// }

// console.log(numberQuantityCheack(10));
...
// console.log(maxElemet([23,43,5,24,35]));
...
// let minusAnPlusNumbers = (numbers) =>{
//     let minusNumbers = 0
//     let plusNumbers = 0
//     for (let i = 0; i < numbers.length; i++) {
//         if (numbers[i] > 0) {
...
//     }
//     return {minusNumbers,plusNumbers}
    
// }

// console.log(minusAnPlusNumbers([32,43,-4,54,-2]));
